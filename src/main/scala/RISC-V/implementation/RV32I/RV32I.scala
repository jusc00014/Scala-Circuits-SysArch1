...
//Setze MISA (Maschienen-ID und Fähigkeiten des Prozessors)
...
// Assign the register file interface
  ...
  io_reg.reg_write_en := control_unit.io_ctrl.reg_we  //Signal der Steuereinheit verbinden, ob in ein Register geschriebne wird
